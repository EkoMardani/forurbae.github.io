...
<html lang="en">
	...
	<body onload="init()">
		...
		<div class="container">
			...
			<div class="pengembang">Eko Mardani</div>
		</div>
		...
		<script type="text/javascript">
			...
			function startTime() {
				...
				if (H<5){
					...
					txt='Good Morning Bae';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
				else if(H<12){
					txt='Be Happy Today Hunny';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
				else if(H<16){
					txt='Good Afternoon Bae';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
					...
					txt='Time to Sleep, Good Night Izatti';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
